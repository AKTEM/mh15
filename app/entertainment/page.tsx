...
async function getEntertainmentData() {
  try {
    const posts = await getPostsByCategory('entertainment', 12);
...
export default async function EntertainmentPage() {
  const articles = await getEntertainmentData();
        ...
        <div className="bg-gray-50 dark:bg-gray-800 py-4">
          <div className="container mx-auto px-4">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span className="text-gray-900 dark:text-white">Entertainment</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-pink-600 to-pink-700 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">Entertainment</h1>
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Discover the latest in movies, music, celebrity news, arts, culture, 
