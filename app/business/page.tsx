...
async function getBusinessData() {
  try {
    const posts = await getPostsByCategory('business', 12);
...
export default async function BusinessPage() {
  const articles = await getBusinessData();
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">Business</h1>
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Get the latest business news, market insights, economic analysis, 
                and corporate developments from around the globe.
              </p>
            </div>
          </div>
        </div>
