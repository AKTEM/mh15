...
import { Calendar, Clock, Eye, User, PartyPopper, ChevronDown, ChevronUp } from 'lucide-react';
...
export const Events: React.FC<EventsProps> = ({ articles }) => {
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950 dark:to-pink-950 rounded-xl p-6 mb-8">
      ...
      {displayedArticles.length > 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Check back soon for upcoming Canadian events and festivals.
          </p>
        </div>
      )}
      ...
      <div className="text-center">
        {articles.length > 3 && (
          <>
            ...
            >
              <span>{showAll ? 'Show Less' : 'View Full Calendar'}</span>
              {showAll ? (
