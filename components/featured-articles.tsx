...
import { FileText, Clock, Eye, User, Award, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      {displayedArticles.length > 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Check back soon for in-depth analysis and commentary.
          </p>
        </div>
      )}
      ...
      <div className="text-center">
        {articles.length > 3 && (
          <>
            ...
            >
              <span>{showAll ? 'Show Less' : 'View All Featured Articles'}</span>
              {showAll ? (
