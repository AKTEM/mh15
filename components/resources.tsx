...
import { BookOpen, Clock, Eye, User, Archive, ChevronDown, ChevronUp } from 'lucide-react';
...
export const Resources: React.FC<ResourcesProps> = ({ articles }) => {
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-950 dark:to-gray-950 rounded-xl p-6 mb-8">
      ...
      {displayedArticles.length > 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Check back soon for comprehensive guides and references.
          </p>
        </div>
      )}
      ...
      <div className="text-center">
        {articles.length > 3 && (
          <>
            ...
            >
              <span>{showAll ? 'Show Less' : 'Browse All Resources'}</span>
              {showAll ? (
